...
public class TaskServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			case "list":
				...
				if (id != null)
					listTask(request, response, Integer.parseInt(id), "no");
				else
	...
	private void listTask(HttpServletRequest request, HttpServletResponse response, int employeeID, String isMyTask)
			throws ServletException, IOException {
	...
	private void insertTask(HttpServletRequest request, HttpServletResponse response, int employeeID)
			throws ServletException, IOException {
	...
	private void updateTask(HttpServletRequest request, HttpServletResponse response, int employeeID, String text)
			throws ServletException, IOException {
	...
	private void deleteTask(HttpServletRequest request, HttpServletResponse response, int employeeID)
			throws ServletException, IOException {
		int taskID = Integer.parseInt(request.getParameter("id"));
	...
	private void deleteCompTask(HttpServletRequest request, HttpServletResponse response, int employeeID)
			throws ServletException, IOException {
