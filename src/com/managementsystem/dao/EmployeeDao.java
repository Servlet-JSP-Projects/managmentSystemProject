...
public class EmployeeDao {
	...
	public static List<Employee> TeamDevloper(int id) {
		...
		try {
			...
			PreparedStatement preparedStatement = connection.prepareStatement(
					"select * from employee join employee_team on employee.employee_id=employee_team.employee_id where team_id=?");
	...
	public static List<Team> Team() {
		...
		try {
			PreparedStatement preparedStatement1 = connection.prepareStatement(
					"select * from employee inner join team on employee.employee_id=team.team_leader_id "
							+ "where employee_rule=?");
	...
	public static void addEmployee(Employee employee) {
		try {
			PreparedStatement preparedStatement = connection.prepareStatement(
					"INSERT INTO employee (employee_id,first_name,last_name,address,phone,email,password,employee_rule) VALUES (?,?,?,?,?,?,?,?)");
	...
	public static void deleteDeveloper(int id) {
		try {
			...
			PreparedStatement preparedStatement2 = connection
					.prepareStatement("delete from employee_team where employee_id=?");
	...
	public static void deleteTeamLeader(int id) {
		try {
			...
			PreparedStatement preparedStatement3 = connection
					.prepareStatement("delete from employee_team where team_id=?");
			preparedStatement3.setInt(1, teamID);
			preparedStatement3.executeUpdate();

			PreparedStatement preparedStatement4 = connection
					.prepareStatement("delete from team where team_leader_id=?");
