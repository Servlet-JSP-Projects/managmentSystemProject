...
import static com.managementsystem.constant.Constant.CREATE_DATE;
import static com.managementsystem.constant.Constant.DESCRIPTION;
import static com.managementsystem.constant.Constant.EMPLOYEE_ID;
import static com.managementsystem.constant.Constant.FINISH_DATE;
import static com.managementsystem.constant.Constant.NAME;
import static com.managementsystem.constant.Constant.STATUS;
import static com.managementsystem.constant.Constant.TASK_ID;
	...
	public static void insertTask(int employeeID, String name, String description) {
		...
		try {
			PreparedStatement preparedStatement = connection.prepareStatement(
					"INSERT INTO task (task_id,name,description,status,create_date,finish_date,employee_id) VALUES (?,?,?,?,?,?,?)");
