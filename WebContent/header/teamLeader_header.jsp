<%@ page language="java" contentType="text/html; charset=windows-1256"
 ...
 <header>
		   ...
		   <div style="width:31.5rem;padding-left:15rem;">
			   <a class="active" href="<%=request.getContextPath()%>/Task?action=list">My Task</a>
			   <a class="active" href="<%=request.getContextPath()%>/Task?action=new">Add Task</a>
			   <a class="active" href="<%=request.getContextPath()%>/Employee?action=developerTeam">Developer Team</a>
			   <div class="dropdown">
